...
use crate::components::{
    Attack, BossWizard, BossWizardStaff, Cyclops, CyclopsCharge, Defense, Enemy, EnemyAIState,
    EnemyAlert, EnemyAttack, EnemyBehaviorState, EnemyPatrol, EnemySpeeds, Health, Slime,
...
fn spawn_enemies_for_level(
    ...
    let mut needed = definition.enemy_counts.slimes + definition.enemy_counts.cyclops;
...
fn spawn_boss_wizard_entity(
    ...
    let boss_entity = commands
        .spawn((
            ...
            Health::new(WIZARD_BOSS_HEALTH),
            Attack::new(WIZARD_BOSS_BASE_ATTACK),
            Defense::new(WIZARD_BOSS_BASE_DEFENSE),
            EnemyAIState {
                state: EnemyBehaviorState::Patrolling,
            },
            EnemyPatrol {
